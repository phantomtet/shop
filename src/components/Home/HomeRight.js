...
export default function HomeRight () {
    ...
    return (
        <div className='color2 right collapse830' style={{position: 'fixed',top: 50, padding: '0px 5px 10px 5px', right: '0', width: '25vw', maxWidth: '360px', minWidth: '250px', height: 'calc(100vh - 50px)', color: 'whitesmoke'}}>
