...
export default function HomeLeft () {
    ...
    return (
        <div className='color2 left' style={{position: 'fixed', height: 'calc(100vh - 50px)', left: 0, top: 50, width: '25vw', maxWidth: '360px', padding: '10px 5px 10px 5px', color: 'whitesmoke', overflow: 'auto'}}>
